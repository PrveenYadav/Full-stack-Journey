    ...
    <div className="relative mb-4">
      ...
      {isPasswordField && (
        <button
          ...
          className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors"
        >
...
const AuthCard = ({ title, subtitle, children }) => (
  <div className="w-full sm:ml-35 md:ml-[25%] lg:ml-[35%] my-30 sm:max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden transform transition-all p-8">
...
export const UserLogin = () => {
  ...
  const subtitles = {
    login: "Sign in to your FoodieGo account",
    register: "Join FoodieGo today",
    ...
    <AuthCard title={titles[view]} subtitle={subtitles[view]}>
      <form onSubmit={handleAuth}>
        ...
        <button
          disabled={loading}
          type="submit"
          className="w-full flex items-center justify-center py-3 px-4 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold transition-all disabled:opacity-70 mt-4 cursor-pointer"
        >
          {loading ? (
