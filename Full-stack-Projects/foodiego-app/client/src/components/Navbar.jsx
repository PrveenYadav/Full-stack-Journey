...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-gray-900/80 dark:text-white flex items-center justify-around text-center sm:pl-20 sm:pr-20 py-5 lg:py-6'>
