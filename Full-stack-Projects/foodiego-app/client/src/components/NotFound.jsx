...
const NotFound = () => {
  ...
  return (
    <div className='w-full h-80 bg-white dark:bg-gray-900 text-black dark:text-white flex flex-col justify-center items-center gap-5'>
        ...
        <button onClick={() => navigate('/')} className='flex gap-1 bg-orange-400 p-2 text-black font-semibold hover:scale-105 hover:opacity-90 rounded cursor-pointer transition-all duration-200 ease-in-out'><ArrowLeft className='h-6 w-6'/>Go Back Home</button>
    </div>
  )
}
