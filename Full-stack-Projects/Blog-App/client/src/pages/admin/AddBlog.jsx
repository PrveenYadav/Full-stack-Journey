      ...
      <div className='bg-white dark:bg-gradient-to-bl from-black via-[#0a0a23] to-[#1e3a8a] w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button 
            ...
            className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70 dark:bg-white dark:text-black px-4 py-1.5 rounded hover:underline cursor-pointer'
          >
            Generate with AI
          </button>
        </div>
        ...
        <select onChange={(e) => setCategory(e.target.value)} name="category" className='mt-2 px-3 py-2 border text-gray-100 dark:gray-300 dark:bg-gray-800 border-gray-300 outline-none rounded'>
