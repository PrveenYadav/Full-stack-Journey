      ...
      <div className='flex flex-wrap gap-4'>
        ...
        <div className='flex items-center gap-4 bg-white dark:bg-slate-900 p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <p className='text-gray-400 dark:text-gray-100 font-light'>Blogs</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white dark:bg-slate-900 p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <p className='text-gray-400 dark:text-gray-100 font-light'>Comments</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white dark:bg-slate-900 p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <p className='text-gray-400 dark:text-gray-100 font-light'>Drafts</p>
          </div>
        </div>
      </div>

      <div>
        <div className='flex items-center gap-3 m-4 mt-6 text-gray-600 dark:text-gray-100'>
