      ...
      <div className="dark:text-white flex lg:flex-row flex-col max-w-screen p-10 pb-0 justify-around items-center">
        ...
        <div className='flex border flex-col gap-3 justify-center p-5 backdrop-blur-xl rounded-2xl w-[300px] lg:w-[400px]'>
          ...
          <div className='flex justify-between mb-5'>
            ...
            <p className='bg-yellow-300 font-semibold px-2 py-1 border-white dark:text-black rounded w-fit hidden lg:inline-block'>{product.tag}</p>
          </div>
          <button onClick={() => addToCart(product)} className='bg-black dark:bg-white text-white dark:text-black mb-5 rounded font-semibold cursor-pointer px-2 py-1 w-[150px] lg:w-[150px]'>+<span className='ml-5'>Add to cart</span></button>
        </div>
