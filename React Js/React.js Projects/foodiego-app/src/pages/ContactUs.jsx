    ...
    <div className='text-black dark:text-white w-[100%] h-full px-10 flex flex-col items-center bg-gradient-to-t from-white dark:from-gray-900 via-white dark:via-gray-900 to-yellow-700/15'>
        ...
        <div className='flex flex-col gap-10 lg:flex-row justify-between mt-10 sm:w-[80%]'>
            <div className='w-full lg:w-[47%] flex flex-col gap-5'>
                ...
                <div className='bg-gray-50 dark:bg-gray-800 shadow-md p-5 flex rounded-xl items-center gap-5'>
                    <div className='bg-yellow-500/15 rounded p-2'>
                        <Phone className='text-yellow-500 h-7 w-7'/>
                    </div>
                    <div>
                        <h3 className='font-bold'>Phone</h3>
                        <p className='font-semibold hover:text-yellow-500 cursor-pointer opacity-60'>+1 (555) 123-457</p>
                    </div>
                </div>
                <div className='bg-gray-50 dark:bg-gray-800 shadow-md p-5 flex rounded-xl items-center gap-5'>
                    <div className='bg-yellow-500/15 rounded p-2'>
                    ...
                    <div>
                        ...
                        <p className='font-semibold hover:text-yellow-500 cursor-pointer opacity-60'>support@gmail.com</p>
                    </div>
                </div>
                <div className='bg-gray-50 dark:bg-gray-800 shadow-md p-5 flex rounded-xl items-center gap-5'>
                    <div className='bg-yellow-500/15 rounded p-2'>
                        <MapPin className='text-yellow-500 h-7 w-7'/>
                    </div>
                    <div>
                        <h3 className='font-bold'>Address</h3>
                        <p className='font-semibold hover:text-yellow-500 cursor-pointer opacity-60'>123 Food Street, New York, NY 10001</p>
                    </div>
                </div>
                <div className='bg-gray-50 dark:bg-gray-800 shadow-md p-5 flex rounded-xl items-center gap-5'>
                    <div className='bg-yellow-500/15 rounded p-2'>
                    ...
                    <div>
                        ...
                        <p className='font-semibold hover:text-yellow-500 cursor-pointer opacity-60'>Mon-Sun: 9:00 AM - 11:00 PM</p>
                    </div>
                </div>
